...
/// <summary>
/// Defines the global configuration for RK.
/// </summary>
...
/// <summary>
/// Loads the global configuration for RK.
/// </summary>
/// <returns>
...
/// <summary>
/// Creates the RK configuration registry key with full access to all users.
/// </summary>
/// <returns>
...
/// <summary>
/// Deletes the RK configuration from the registry.
/// </summary>
